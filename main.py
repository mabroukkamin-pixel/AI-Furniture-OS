...
# --- دالة التنظيف والتصحيح اللغوي الدقيق لمنع أي أخطاء في نطق الأرقام ---
def normalize_text(text):
    # تحويل الأرقام الفردية إلى نصوص عربية صحيحة للنطق
    replacements = {
        "0": " صفر ", "1": " واحد ", "2": " اثنين ", "3": " ثلاثة ", "4": " أربعة ", 
        "5": " خمسة ", "6": " ستة ", "7": " سبعة ", "8": " ثمانية ", "9": " تسعة ",
        "×": " في ", "x": " في ", "/": " شرطة ", "سم": " سنتيمتر "
    }
    # ملاحظة: إذا كان السعر رقم كبير (مثلاً 120)، يفضل قراءته كـ "مائة وعشرون" 
    # لكن التعديل ده بيضمن إن كل رقم لوحده ينطق صح ومينطقش أرقام إنجليزية غريبة
